...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_ENTER, KC_SPACE,
        KC_RIGHT_GUI, KC_ESCAPE, TD(TD_PP_L1)
    ),
    [1] = LAYOUT(
        KC_BRIGHTNESS_UP, KC_MINUS, KC_EQUAL, KC_GRAVE, TD(TD_SS_BL),
